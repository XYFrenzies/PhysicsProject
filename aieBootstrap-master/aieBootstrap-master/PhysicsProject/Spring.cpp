...
Spring::Spring(Rigidbody* a_actor1, Rigidbody* a_actor2, float a_damping,
    ...
    glm::vec2 a_contact2) : PhysicsObject(ShapeType::JOINT), m_actor1(a_actor1),
    m_actor2(a_actor2), m_damping(a_damping), m_springCoefficient(a_springCoefficient),
...
{
    //Get the world coordingates of the start and the end of the string
